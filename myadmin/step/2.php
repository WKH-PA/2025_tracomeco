            ...
            <div class="tab-pane <?= $count_lang == 1 ? "active" : "" ?>" id="tab_<?= $count_lang ?>">
                    ...
                    <div class="form-group" style="background: #efefef; padding: 10px;">
                        ...
                        <div class="dv-lbtinhnang flex">
                            ...
                            foreach ($tinhnang_arr as $val2) {
                                if ($val2['id_parent'] != $value['id'])
                                    continue;
                                ?>
                                <p style="margin: 10px 0 3px; padding: 0; font-size: 12px; font-weight: 600;">
                                    <?= $val2['tenbaiviet_' . $lang] ?>
                                </p>
                ...
                <?php if (!in_array($step, $st_bv_mota)) { ?>
                    <div class="form-group">
                        ...
                        <textarea id="thongtin_<?= $lang ?>" name="mota_<?= $lang ?>" class="form-control paEditor">
            ...
            <div class="form-group">
                ...
                <div class="dv-lbtinhnang flex dv-nd-tinhnang">
                    ...
                    foreach ($tinhnang_arr as $val2) {
                        ...
                        ?>
                        <label>
                            <input type="checkbox" name="tinhnang_arr[]" value="<?= $value['id'] . '_' . $val2['id'] ?>"
                                <?= !empty($list_arr) && in_array($value['id'] . '_' . $val2['id'], @$list_arr) ? 'checked="checked"' : "" ?>>
                            <span>
                                <?= $val2['tenbaiviet_vi'] ?>
                            </span>
                        </label>
                    ...
                    <select name="tinhnang_arr[]" id="id_parent" class="form-control">
                        ...
                        foreach ($tinhnang_arr as $val2) {
                            if ($val2['id_parent'] != $value['id'])
                                continue;
                            ?>
                            <option value="<?= $value['id'] . '_' . $val2['id'] ?>" <?= !empty($list_arr) && in_array($value['id'] . '_' . $val2['id'], @$list_arr) ? 'selected="selected"' : "" ?>><?= $val2['tenbaiviet_vi'] ?>
                            </option>
                        <?php } ?>
                    </select>
                    <div class="clear"></div>
...
<div class="box p10">
    ...
    <?php if (in_array($step, $check_video)) { ?>
        <div class="form-group">
            <label>Link Video <a
                    data-tooltip="Nhập link Video Youtube. Ví dụ: https://www.youtube.com/watch?v=SQ-KWxC7Eoo&feature=emb_logo">
                </a></label>
    ...
    <div class="form-group">
        ...
        <label class="noweight noweight-top checkbox-mini">
            <input class="minimal auto_get_link" type="checkbox" <?= empty($id) || $id == 0 ? 'checked="checked"' : '' ?>>
