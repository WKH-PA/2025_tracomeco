...
$dataAboutStyle = $slug_table == 'danhmuc' ? $arr_running : [];

if ($templateId == 2 && $slug_table != 'danhmuc') {
    $dataAboutStyle = DB_fet("*",
        "#_danhmuc",
        "`step` = $tempDataStep and showhi =1 and id=" . $aboutData['id_parent'],
        " `catasort` ASC", "", "arr");
    $dataAboutStyle= current($dataAboutStyle);
}
